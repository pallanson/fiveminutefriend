...
class RegisterFragment : Fragment() {
            ...
            if(edit_email_register.text.isBlank()
                ...
                confirmationDialog.setTitle("Register Account?")
                        ...
                        .setPositiveButton("Register") { dialog, which ->
                            registerUser(edit_email_register.text.toString().trim(),
                        ...
                        .setNegativeButton("Cancel") { dialog, which ->
                            Toast.makeText(activity, "Cancelled", Toast.LENGTH_SHORT)
                        }
                        .create()
                        .show()
            }
                ...
                .addOnCompleteListener({ task: Task<AuthResult> ->
                    if (task.isSuccessful) {
                        dbReference
                                ...
                                .setValue(User(firebaseAuth.uid.toString(),
                                        firstName,
                                        lastName,
                                        username,
                                        email,
    ...
    fun createNumberPicker(type: Int) {
        if (type == 0) {
            ...
            dialogBuilder.setView(genderPicker)
                    ...
                    .setPositiveButton("Ok") { dialog, which ->
                        if (genderPicker.value == 0) {
                            text_select_gender_register.text = "Male"
                        } else if (genderPicker.value == 1) {
                            text_select_gender_register.text = "Female"
                        } else if (genderPicker.value == 2) {
                            text_select_gender_register.text = "Other"
                        }
                    }
                    .setNegativeButton("Cancel") { dialog, which ->
            ...
            var ageValues = Array<String>(100, { "$it"} )
